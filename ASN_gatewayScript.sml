...
open HolKernel Parse boolLib bossLib limTheory arithmeticTheory realTheory 
     ...
     lebesgueTheory real_sigmaTheory satTheory numTheory dep_rewrite RBDTheory FT_deepTheory VDCTheory;
...
val list_exp_def =  Define
    		     	`(list_exp p [] L = T ) /\
		(list_exp p (h::t) L = 
		(exp_dist p (HD L) (h)) /\ (list_exp p (t) (TL L)))`; 

(*=================probability of B1=====================================*)
val B1_FT_def = Define
 `B1_FT p t D1 D4 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E21 = 
 (OR
     [OR [atomic (fail_event p D1 t); 
     	  AND [OR (gate_list (fail_event_list p [E1; E2] t));  
	       atomic (fail_event p E21 t)];
          OR (gate_list(fail_event_list p [E3; E4; E5] t))];
      OR [atomic (fail_event p D4 t); 
      	  AND [OR (gate_list (fail_event_list p [E6; E7] t)); 
	       atomic (fail_event p E21 t)];
...
val B2_FT_def = Define
 ...
 (OR
     [OR [atomic (fail_event p D7 t); 
     	  AND [OR (gate_list (fail_event_list p [E11; E12] t));  
	       atomic (fail_event p E21 t)];
          OR (gate_list(fail_event_list p [E13; E14; E15] t))];
      OR [atomic (fail_event p D10 t); 
      	  AND [OR (gate_list(fail_event_list p [E16; E17] t)); 
	       atomic (fail_event p E21 t)];
...
val A_FT_def = Define
 `A_FT p t D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12
  ...
  (OR [B1_FT p t D1 D4 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E21;
      B2_FT p t D7 D10 E11 E12 E13 E14 E15 E16 E17 E18 E19 E20 E21; 
      AND [OR (gate_list (fail_event_list p [C5; C6; C7] t)); 
      	   atomic (fail_event p C8 t)]])`;
(*=================probability of RT=====================================*)
val RT_FT_def = Define
 `RT_FT p t AL SL PD Others time =  
  AND [OR (gate_list (fail_event_list p [AL; SL; PD; Others] t)); 
       atomic (fail_event p time t)] `;

(*=================probability of internal===============================*)

val Internal_FT_def = Define
 `Internal_FT p t FD AP FF1 D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 
 	      E12 E13 E14 E15 E16 E17 E18 E19 E20 E21 C5 C6 C7 C8 notshw AL 
	      SL PD Others time = 
  OR [AND [OR (gate_list(fail_event_list p [FD; AP] t));  
     	   atomic (fail_event p FF1 t)]; 
      OR [A_FT p t D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12
               E13 E14 E15 E16 E17 E18 E19 E20 E21 C5 C6 C7 C8;  
...
(*=================probability of ASN gateway =====================================*)
 ...
 `ASN_gateway_FT p t FD AP FF1 D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12 E13 
 		 E14 E15 E16 E17 E18 E19 E20 E21 C5 C6 C7 C8 notshw AL SL PD Others time 
...
val ASN_FT_eq_parallel_series_RBD = store_thm("ASN_FT_eq_parallel_series_RBD",
  ``!p t FD AP FF1 D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12
     ...
     (ASN_gateway_FT p t FD AP FF1 D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8
		     ...
		     C5 C6 C7 C8 notshw AL SL PD Others time ED EQ1 EN1 EN2 EN3 EN4 human = 
      rbd_struct p ((parallel of (λa. series (rbd_list a ))) 
         (list_fail_event_list p 
	   [[ED; EQ1];[EN1; EN2; EN3; EN4];[human];[FD; FF1];[FF1; AP];
	    [D1];[D4];[E1;E21];[E2;E21];[E3];[E4];[E5];[E6;E21];[E7;E21];
	    [E8];[E9];[E10];[D7];[D10];[E11;E21];[E12;E21];[E13];[E14];[E15];
	    [E16;E21];[E17;E21];[E18];[E19];[E20];[C5; C8];[C6; C8];[C7; C8];
	    [notshw];[AL; time];[SL; time];[PD; time];[Others;time]] t)))``,
RW_TAC list_ss[ASN_gateway_FT_def,Internal_FT_def,A_FT_def,B1_FT_def,B2_FT_def,RT_FT_def,
	       FTree_def,INTER_DEF,rbd_struct_def,list_fail_event_list_def,fail_event_list_def,
	       fail_event_def,gate_list_def,rbd_list_def,of_DEF,o_DEF,UNION_DEF]
++ SET_TAC[]);
    ...
    (one_minus_list
       (list_prod_rel p
          (list_fail_event_list p
             [ [E1; E21]; [E2; E21];
              [E6; E21]; [E7; E21]] t))))``,
RW_TAC list_ss[list_fail_event_list_def,fail_event_list_def,fail_event_def,
	       list_prod_rel_def,one_minus_list_def,list_prob_def,list_prod_def]
...
(0 <= t) /\ prob_space p /\ 
(list_exp p (FLAT [[C_E1; C_E21]; [C_E2; C_E21]; [C_E6; C_E21]; [C_E7; C_E21]]) 
...
RW_TAC list_ss[list_exp_def,exp_distribution_def,distribution_def,CDF_def,
	       list_fail_event_list_def,fail_event_list_def,fail_event_def,
	       list_prod_rel_def,list_prod_def,list_prob_def]
++ RW_TAC list_ss[one_minus_list_def,list_prod_def,one_minus_exp_prod_def,
		  exp_func_list_def,list_sum_def,exp_func_def]
++ RW_TAC std_ss[REAL_MUL_ASSOC]
++ RW_TAC real_ss[]);
...
(0 <= t) /\ prob_space p/\
(list_exp p (FLAT [[C_AL;C_time]; [C_SL;C_time]; [C_PD;C_time]; [C_Others;C_time]]) 
    ...
    (one_minus_list
       (list_prod_rel p
          (list_fail_event_list p
             [[D1]; [D4]; [E3]; [E4]; [E5];
               [E8]; [E9]; [E10]] t ))) = 
 exp (- (t * list_sum [C_D1; C_D4; C_E3; C_E4; C_E5; C_E8; C_E9; C_E10])))``,
RW_TAC list_ss[list_exp_def,exp_distribution_def,distribution_def,CDF_def,
	       list_fail_event_list_def,fail_event_list_def,fail_event_def,
	       list_prod_rel_def,list_prod_def,list_prob_def]
++ RW_TAC list_ss[one_minus_list_def,list_prod_def,one_minus_exp_prod_def,
...
val A_FT_lemma1 = store_thm("A_FT_lemma1",
  ``!p t D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12 E13 E14 E15 E16 E17 
       E18 E19 E20 E21 C5 C6 C7 C8 notshw AL time SL PD Others. 
list_prod
  (one_minus_list
     (list_prod_rel p
        (list_fail_event_list p
...
(0 <= t) /\ prob_space p /\ 
(list_exp p (FLAT [[C_FD;C_FF1];[C_AP;C_FF1]]) (FLAT [[FD;FF1];[AP;FF1]])) ==> 
(list_prod
       (one_minus_list
          (list_prod_rel p
...
(0 <= t) /\  prob_space p /\ 
(list_exp p (FLAT [[C_ED;C_EQ1];[C_EN1;C_EN2;C_EN3;C_EN4];[C_human]])
...
++ RW_TAC real_ss[REAL_MUL_ASSOC]);
(*------------------------------------------------------------------------*)
val ASN_gateway_lem6 = store_thm("ASN_gateway_lem6",
...
val ASN_gateway_thm = store_thm("ASN_gateway_thm",
  ``!p t FD AP FF1 D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12
      ...
      C_EN3 C_EN4 C_human C_FD C_AP C_FF1 C_notshw C_AL C_SL C_PD C_Others 
      C_time C_C5 C_C6 C_C7 C_C8 C_E1 C_E2 C_E6 C_E7 C_D1 C_D4 C_E3 C_E4 
      C_E5 C_E8 C_E9 C_E10 C_E11 C_E12 C_E16 C_E17 C_D7 C_D10 C_E13 C_E14 
      C_E15 C_E18 C_E19 C_E20 C_E21. 
(0 <= t) /\  prob_space p  /\
 (!x'.
    MEM x'
      (FLAT
...
(list_exp p
  ...
  (prob p (ASN_gateway_FT p t FD AP FF1 D1 D4 D7 D10 E1 E2 E3 E4 E5 E6 E7 E8
       	  		  E9 E10 E11 E12 E13 E14 E15 E16 E17 E18 E19 E20 E21 
			  C5 C6 C7 C8 notshw AL SL PD Others time ED EQ1 EN1 
			  EN2 EN3 EN4 human) = 
1 -
list_prod
  (one_minus_exp_prod t
